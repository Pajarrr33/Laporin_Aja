...
<body>
    ...
    <header class="bg-white fixed w-full z-10 top-0 m-0">
        <div class="container">
            ...
            <nav class="bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
                <div class="flow-root">
                    <div class="flex flex-col px-6 -my-2 space-y-1">
                        <a href="#" class="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">Services</a>
                        <a href="#" class="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">About</a>
                        <a href="#" class="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">Contact</a>
                    </div>
                </div>
            </nav>
        </div>
    ...
    <section id="introduction" style="background-color: #f2e9e9;">
        <div class="py-16">  
    ...
    <section class="py-12 bg-white sm:py-16 lg:py-20">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
                <div class="md:p-8 lg:p-14 mb-0 pb-0">
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 mb-0 pb-0">
                ...
                <div class="md:p-8 lg:p-14 md:border-t md:border-gray-200 mb-0 pb-0">
                ...
                <div class="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t mb-0 pb-0">
    ...
    <section class="mb-32 text-center md:text-left" style="background-color: #b0d1c4;">
